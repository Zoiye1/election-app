package nl.hva.stack5.election.utils.xml;
...
abstract class AbstractParserTests {
    ...
    protected nl.hva.stack5.election.utils.xml.DutchElectionParser electionProcessor;

    /**
     * This transformer add the election data on each method invocation to a list.
     */
    protected static class TestTransformer implements nl.hva.stack5.election.utils.xml.DefinitionTransformer, nl.hva.stack5.election.utils.xml.CandidateTransformer, nl.hva.stack5.election.utils.xml.VotesTransformer {
    ...
    void setUp() {
        ...
        electionProcessor = new nl.hva.stack5.election.utils.xml.DutchElectionParser(
                transformer,
                transformer,
                transformer,
                transformer,
